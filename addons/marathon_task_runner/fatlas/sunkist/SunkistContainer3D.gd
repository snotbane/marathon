...
@tool
@icon("res://addons/marathon_task_runner/ui/icons/sunkist_3d.svg")
class_name SunkistContainer3D
extends Node3D

const PREVIEW_CANVAS_MATERIAL := preload("res://addons/marathon_task_runner/fatlas/sunkist/materials/mat_sunkist_canvas.tres")
