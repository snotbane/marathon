...
var PREVIEW_GENERATOR_SCRIPT := preload("res://addons/marathon_task_runner/sunkist/SunkistTexture_PreviewGenerator.gd")
var preview_generator: EditorResourcePreviewGenerator


var MAIN_SCENE := preload("res://addons/marathon_task_runner/sunkist/scenes/SunkistViewer.tscn")
...
func _get_plugin_icon() -> Texture2D:
	return preload("res://addons/marathon_task_runner/ui/icons/layers.svg")
