...
const PLAY_ICON: Texture2D = preload("res://addons/marathon_task_runner/runner/icons/Play.svg")

const STOP_ICON: Texture2D = preload("res://addons/marathon_task_runner/runner/icons/Stop.svg")

const RESET_ICON: Texture2D = preload("res://addons/marathon_task_runner/runner/icons/Reload.svg")

const OPEN_ICON: Texture2D = preload("res://addons/marathon_task_runner/runner/icons/ExternalLink.svg")

const COPY_ICON: Texture2D = preload("res://addons/marathon_task_runner/runner/icons/ActionCopy.svg")

const REMOVE_ICON: Texture2D = preload("res://addons/marathon_task_runner/runner/icons/Remove.svg")
